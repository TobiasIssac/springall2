...
public class MyAspect {
     ...
     * 2)方法没有返回值void
     * 3)方法名称自定义
     * 4)方法有参数(也可以没有参数,如果目标方法没有返回值,则可以写无参的方法,但一般会写有参,这样可以处理无参可以处理有参),
     * 这个切面方法的参数就是目标方法的返回值
     ...
     */
    @AfterReturning(value = "execution(* org.example.s02.*.*(..))",returning = "obj")
    public void myAspectReturning(Object obj){
